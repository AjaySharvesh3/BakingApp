package com.sharvesh.flick.bakingapplication.utility;
...
import com.sharvesh.flick.bakingapplication.models.Steps;
    ...
    public ArrayList<Recipe> getRecipesFromJson(String JsonStr) throws JSONException {
        ...
        try {
            ...
            for (int i = 0; i < recipeArray.length(); i++) {
                ...
                ArrayList<com.sharvesh.flick.bakingapplication.models.Ingredients> ingredientsArrayList=new ArrayList<>();
                ...
                for (int k = 0; k < StepsArray.length(); k++) {
                    ...
                    com.sharvesh.flick.bakingapplication.models.Steps Step=new Steps(stepsIDJson,ShortDescriptionJson,descriptionJson,VideoURLJson,ThumbURLJson);
